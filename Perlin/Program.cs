        ...
        static void Main(string[] args)
        {
            ...
            for (var i = 0; i < 100; i++)
            {
                for (var j = 0; j < 100; j++)
                {
                    ...
                    int maxColor = 128;//16777215;
                    int noiseColor = (int)(maxColor*noise);
                    var noiseHexColor = Convert.ToInt32((0xFF0000 + noiseColor).ToString("X"),16);
                    bm.SetPixel(i,j,Color.FromArgb(noiseHexColor));
